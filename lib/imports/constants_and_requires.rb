# Built in libraries used within sqlscanner
require 'rubygems'
require 'mechanize'
require 'nokogiri'
require 'rest-client'
...
# The version that sqlscanner is currently in
VERSION = sqlscanner::Misc.new.version

# What type of version do you have? Is there an upgrade? Stable? Dev version?
VERSION_TYPE = sqlscanner::Misc.new.version_type(VERSION)

# Download link for the banner
DOWNLOAD_LINK = "Downloads: https://github.com/sqlscannerScanner/sqlscanner/releases".cyan

# Repository link for the banner
REPO_LINK = "Clone: https://github.com/sqlscannerScanner/sqlscanner.git".cyan
...
# Default user agent used by sqlscanner
DEFAULT_USER_AGENT = "sqlscanner #{VERSION} SQL Vuln Scanner/Ruby:#{RUBY_VERSION}->Platform:#{RUBY_PLATFORM}"

# Link to sqlscanners function page on the wiki
FUNCTION_PAGE_LINK = "https://github.com/sqlscannerScanner/sqlscanner/wiki/Functionality"
